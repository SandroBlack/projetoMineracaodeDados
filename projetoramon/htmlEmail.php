												...
												<table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
													<tr>
														<td style="color:#187272;">
															<br>
															Clique em ativar conta para começar a criar seus formluários.
															<br>
															<br>
														</td>
													</tr>
									...
									<tr>
										<td>
											<div>
												...
												<![endif]-->
												<a href="http://"
												style="background-color:#178f8f;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Ativar Conta!</a>
												<!--[if mso]>
												</center>
												</v:roundrect>
												<![endif]-->
