...
<html lang="pt-br">
	...
	<head>
		...
		<script src="js/validacao-aquilla.js"></script>
	...
	<body>
		...
		<div class="container">
			...
			<div class="questoes" id="divPergunta">
				...
				<option id="2" name="2" value="2">Campo de Resposta</option>
				
				<option id="3" name="3" value="3">Multipla Escolha</option>
				
				<option id="4" name="4" value="4">Caixas de Seleção</option>
				
				<option id="5" name="5" value="5">Campo para Cpf</option>
				
				<option id="6" name="6" value="6">Campo para Texto</option>
