$(document).ready(function(){
	...
	$("#duplicar").click(function(){
		...
		else
		{
			...
			if (tipoPergunta == 3)
			{
					...
					arrayOpc[contOpc] = "<input type='"+ tipoInput +"' name='"+ tipoInput + cont + "' value='' disabled='true'> <input type='text' id='respostaOpc" + contOpc + "' name='respostaOpc' placeholder='Digite o valor'>";
	...
	$(document).on('click', '#adicionarOpc', function(){
		...
		arrayOpc[contOpc] = "<input type='"+ tipoInput +"' name='"+ tipoInput + cont + "' value='' disabled='true'> <input type='text' id='respostaOpc" + contOpc + "' name='respostaOpc" + contOpc + "'" +
	...
	$(document).on('click', '#removerOpc', function(){
		...
		else
		{
			...
			for (var i = 0; i < contOpc; i++)
			{
				...
				arrayOpc[i] = "<input type='"+ tipoInput +"' name='"+ tipoInput + cont + "' value='' disabled='true'> <input type='text' id='respostaOpc" + i + "' name='respostaOpc" + i + "'" +
							  "value='"+ recebeOpcUpperCase +"'>";
			}
